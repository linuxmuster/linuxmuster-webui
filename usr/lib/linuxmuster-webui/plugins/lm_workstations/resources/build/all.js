...
(function() {
  ...
  angular.module('lm.workstations').controller('LMWorkstationsController', function($scope, $http, $uibModal, gettext, notify, pageTitle, lmFileEditor, lmFileBackups) {
    ...
    $scope.editCSV = function() {
      return lmFileEditor.show('/etc/linuxmuster/workstations').then(function() {
        return $route.reload();
      });
    };
    return $scope.backups = function() {
      return lmFileBackups.show('/etc/linuxmuster/workstations');
    };
  });
